...
**Theatre:** mecca_urban `(39.3, 21.15, 39.78, 21.68)` (50 x 59 km), fingerprint `d0b3750c15`
...
| `dem/dubai_urban/30m/eb66169b03` | `terrain/dubai_urban_eb66169b03_dem_30m_utm.tif` | 8.3 MB | `3ef83d24c054` | 2026-09-11T09:33:40Z |
| `dem/mecca_urban/30m/d0b3750c15` | `terrain/mecca_urban_d0b3750c15_dem_30m_utm.tif` | 11.5 MB | `da4d5429e8a9` | 2026-09-11T09:33:51Z |
...
| `dem_npz/dubai_urban/eb66169b03` | `terrain/dubai_urban_eb66169b03_dem_30m_utm.npz` | 8.1 MB | `d2e96175d6dd` | 2026-09-11T09:33:40Z |
| `dem_npz/mecca_urban/d0b3750c15` | `terrain/mecca_urban_d0b3750c15_dem_30m_utm.npz` | 11.1 MB | `55edd3c7ec6a` | 2026-09-11T09:33:52Z |
...
| `open_meteo/profile/dubai_urban/eb66169b03` | `atmosphere/open_meteo_dubai_urban_eb66169b03_profile.json` | 0.0 MB | `d5b5cd45d04c` | 2026-09-11T09:33:43Z |
| `open_meteo/profile/mecca_urban/d0b3750c15` | `atmosphere/open_meteo_mecca_urban_d0b3750c15_profile.json` | 0.0 MB | `97a82e68d99a` | 2026-09-11T09:40:30Z |
...
The DEM spans 8.9-764.6 m (755.7 m relief), mean slope 5.57 deg. Running the true line-of-sight test (4/3-Earth geometry, per-ray terrain sampling) from a sensor on the AOI high point against 1500 random points:
...
DEM elevation was compared against published field elevations at 0 airfields: mean difference None m, worst case None m. Two independent sources agreeing to a few metres means the WGS84 -> UTM reprojection every LOS ray depends on is correct.

### The local atmosphere is not the textbook atmosphere

Measured refractivity gradient over the lowest 3 km: -63.21 N-units/km, giving an effective-Earth factor k = 1.6742 against the standard 1.3333. Dry high-desert air refracts less, so the radar horizon is shorter than the default assumption. Surface air density is 0.911 of sea level at the valley floor.
